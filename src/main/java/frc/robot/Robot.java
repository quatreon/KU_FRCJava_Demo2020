...
public class Robot extends TimedRobot {
  //Define Drive Motors
  private PWMVictorSPX rightDrive1 = new PWMVictorSPX(0);
  private PWMVictorSPX rightDrive2 = new PWMVictorSPX(1);
  private PWMVictorSPX leftDrive1 = new PWMVictorSPX(2);
  private PWMVictorSPX leftDrive2 = new PWMVictorSPX(3);
   
  //Define Drive Motor Group
